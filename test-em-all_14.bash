...
--url 'https://dev-nwrzzteb.us.auth0.com/oauth/token' \
--header 'content-type: application/json' \
--data '{"grant_type":"password", "username":"dokkl2323@gmail.com", "password":"hoon2323@#", "audience":"https://localhost:8443/product-composite", "scope":"openid email product:read product:write", "client_id":"bsQiXEF4Xv57OZDoq6bKFbkPIW85f4G0","client_secret":"TsfJY6lQLz0mm0Iha62Fc6RK1sSjJmTcmWzZNy6pTZeoj3CnbQF6vM0faRVbDM8e"}' -s | jq -r .access_token)
...
--url 'https://dev-nwrzzteb.us.auth0.com/oauth/token' \
--header 'content-type: application/json' \
--data '{"grant_type":"password","username":"dokkl2323@gmail.com", "password":"hoon2323@#","audience":"https://localhost:8443/product-composite", "scope":"openid email product:read", "client_id":"bsQiXEF4Xv57OZDoq6bKFbkPIW85f4G0", "client_secret":"TsfJY6lQLz0mm0Iha62Fc6RK1sSjJmTcmWzZNy6pTZeoj3CnbQF6vM0faRVbDM8e"}' -s | jq -r .access_token)
